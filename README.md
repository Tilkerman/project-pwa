...
│       ├── pages.yml       # Деплой на GitHub Pages (Node.js 20)
│       └── deploy.yml      # Альтернативный деплой (Node.js 18)
...
**Workflow файлы:**
- `.github/workflows/pages.yml` - основной workflow (Node.js 20)
- `.github/workflows/deploy.yml` - альтернативный workflow (Node.js 18)

**Доступно по адресу:** https://tilkerman.github.io/project-pwa/

**Настройка деплоя:**
1. Убедитесь, что в `vite.config.ts` указан правильный `base` путь для вашего репозитория
